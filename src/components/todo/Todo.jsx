...
import {editTodo, toggleTodo, deleteTodo} from '../../actions/actions'
...
export class Todo extends Component {
  ...
  render() {
    const{url, title, project, createdAt, done} = this.props;

    return (
      <div className="column">
        <div className="ui brown card">
          <img className="ui image" src={url} alt='imagem aleatoria'/>
          {this.state.formOpen ?
            ...
            <div className="content">
              ...
              <div className="meta">Created {moment(createdAt).fromNow()}</div>
            </div>
          }
            ...
            {this.state.formOpen ?
              ...
              <div>
                <div className="ui toggle checkbox" style={{marginBottom: '10px'}}>
                  <input type="checkbox" name="public" value="on" defaultChecked ={done} onChange={this.handleToggle}/>
